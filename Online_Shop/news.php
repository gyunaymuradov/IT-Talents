<main class="float-left">
    <div class="catalog border">
        <div class="sub-container">
            <h2>HELLO PPL</h2>
            <p class="news"><cite>Posted on: 12.21.2121 by Hekki Jeny</cite></p>
            <img class="news-image" src="assets/images/169.jpg" width="100%" height="150">
            <p class="news">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium aspernatur commodi, ducimus ea eligendi enim illum incidunt labore minima, molestias mollitia necessitatibus nisi perferendis quisquam sequi sit velit voluptate voluptates.</p>
        </div>
