        ...
        <fieldset class="sub-container">
            ...
            <div>
                <form action="addcomment.php" method="post">
                    ...
                    <?php if (!$userLogged)
                        echo "<label class=\"float-left\" for=\"commentator_name\">Name</label>
                    ...
                    <textarea class="float-right comment-input" name="comment_content" id="comment" required></textarea><br>
                    <div id="align-right">
